...
class TestBidirectionalSearch(unittest.TestCase):
    ...
    def test_bidirectional_ucs_explored(self):
        ...
        explored_nodes = sum(list(self.romania.explored_nodes().values()))
        print('BiUCS explore', explored_nodes, list(self.romania.explored_nodes().keys()))
    ...
    # def test_bidirectional_ucs_atlanta(self):
    #     node_positions = {n: self.atlanta.nodes[n]['pos'] for n in
    #                       self.atlanta.nodes.keys()}
    #     #print(node_positions)
    #     start = '3761375467'
    #     goal = '68278310'
    #     TestBasicSearch.draw_graph(self.atlanta, node_positions=node_positions,
    #             start=start, goal=goal, path=[],
    #             title='bi-ucs blue=start, yellow=goal, green=explored')
